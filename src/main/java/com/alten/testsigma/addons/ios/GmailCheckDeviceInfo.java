...
public class GmailCheckDeviceInfo extends IOSAction {
    ...
    public Result execute() throws NoSuchElementException {
        ...
        String piattaforma = minuscFirstLetter(iosDriver.getCapabilities().getCapability("platformName").toString());
        String marca = iosDriver.getCapabilities().getCapability("deviceName").toString();
        String devInfo = piattaforma + " " +marca;
        System.out.println(piattaforma + " " +marca);
        try {
